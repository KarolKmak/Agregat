...
class SavedAdapter(val homeFeed: Array<HomeFeed>): RecyclerView.Adapter<SavedViewHolder>() {
...
class SavedViewHolder(val view: View, var url:String? = null): RecyclerView.ViewHolder(view) {
    companion object{
